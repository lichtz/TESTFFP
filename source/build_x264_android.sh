...
FF_EXTRA_CFLAGS="-DANDROID -Wall -fPIC -march=$CPU  -O2 -mfloat-abi=softfp -mfpu=neon"
...
export LDFLAGS="-march=$CPU -lm"
export CFLAGS="-march=$CPU  -O2 -mfloat-abi=softfp -mfpu=neon"
build_android
